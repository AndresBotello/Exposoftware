...
export function AdminHeader({ userName, userInitials, onLogout, onProfileClick }) {
  return (
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="w-10 h-10 bg-teal-100 rounded-full flex items-center justify-center hover:bg-teal-200 transition-colors cursor-pointer"
              >
